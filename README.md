...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-d5qz0f0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-d5qz0f0.containers.anotherwebservice.com/
...
```
git clone git@github.com:abubalo/container-d5qz0f0.git
cd container-d5qz0f0
```
...
```
docker attach container-d5qz0f0
```
